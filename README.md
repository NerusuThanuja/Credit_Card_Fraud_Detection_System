...
AI-based Credit Card Fraud Detection System using machine learning to classify transactions as fraudulent or legitimate. Includes data preprocessing, model training, and a Streamlit web app for real-time prediction, demonstrating end-to-end AI deployment in financial security.
...
## Learning Outcomes
- Gained hands-on experience with machine learning pipelines
- Learned data preprocessing and model training
- Built and deployed an interactive web app using Streamlit
- Understood real-world challenges like class imbalance and fraud detection

## Author
Nerusu Thanuja  
B.Tech – Artificial Intelligence & Machine Learning(REVA UNIVERSITY)
